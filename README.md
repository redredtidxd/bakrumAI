...
- **Salas de seguridad (FNAF)**: refugios pequeños a propósito (2x2/2x3/3x2 celdas, ~1 de cada 7 chunks) con UNA puerta de metal que sube al techo, alimentada por pilas (se gasta con la puerta cerrada; [E] la abre/cierra y recarga con pilas de repuesto) y el panel de batería justo al lado de la puerta. Tres monitores CRT gruesos (uno por pared) retransmiten en vivo las cámaras de seguridad en visión nocturna verde: cada uno muestra una cámara DISTINTA, barre de lado a lado y [E] sobre la pantalla cambia de cámara. Con la puerta cerrada la Entidad no puede verte ni alcanzarte. El estado de la puerta se comparte con la sala.
